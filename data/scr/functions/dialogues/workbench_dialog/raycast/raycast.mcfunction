...
execute if score .distance dist matches ..1000 positioned ^ ^ ^0.05 rotated ~ ~ if block ~ ~ ~ #scr:raycast_pass run function scr:dialogues/workbench_dialog/raycast/raycast
...
execute if score .distance dist matches ..1000 positioned ^ ^ ^0.05 rotated ~ ~ if block ~ ~ ~ crafting_table run function scr:dialogues/workbench_dialog/raycast/collide_block