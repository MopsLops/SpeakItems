...
#Мотыга рандома
execute as @a[scores={hoe_dialog=9},nbt={Inventory:[{id:"minecraft:pumpkin"}]},tag=!compleate_mushromm_dialog] run function scr:dialogues/hoe_dialog/hoe_dialog3
execute as @a[scores={hoe_dialog=10},nbt={Inventory:[{id:"minecraft:beetroot"}]},tag=!compleate_mushromm_dialog] run function scr:dialogues/hoe_dialog/hoe_dialog3
execute as @a[scores={hoe_dialog=11},nbt={Inventory:[{id:"minecraft:carrot"}]},tag=!compleate_mushromm_dialog] run function scr:dialogues/hoe_dialog/hoe_dialog3
execute as @a[scores={hoe_dialog=13},nbt={Inventory:[{id:"minecraft:potato"}]},tag=!compleate_mushromm_dialog] run function scr:dialogues/hoe_dialog/hoe_dialog3
...
execute as @a[scores={hoe_dialog=11},nbt={Inventory:[{id:"minecraft:axolotl_bucket"}]},tag=!compleate_water_bucket_dialog] run function scr:dialogues/water_bucket_dialog/axelotl
...
execute as @a[scores={stick_dialog=8},nbt={Inventory:[{id:"minecraft:blaze_rod"}]},tag=!compleate_stick_dialog] run function scr:dialogues/stick_dialog/stick_dialog3
...
execute as @a[scores={hoe_dialog=9},nbt={Inventory:[{id:"minecraft:cake"}]},tag=!compleate_workbench_dialog] run function scr:dialogues/workbench_dialog/workbench_complete
...
#Кость
execute as @a[nbt={Inventory:[{id:"minecraft:bone"}]},tag=!start_oak_sapling_dialog,tag=!compleate_oak_sapling_dialog] run function scr:dialogues/oak_sapling_dialog
