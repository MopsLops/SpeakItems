...
execute if score .distance dist matches ..1000 positioned ^ ^ ^0.05 rotated ~ ~ if block ~ ~ ~ #scr:raycast_pass run function scr:items/pickaxe/super_pickaxe/raycast



#если попал в любой блок
execute if score .distance dist matches ..1000 positioned ^ ^ ^0.05 rotated ~ ~ run function scr:items/pickaxe/super_pickaxe/collide_block
