...
execute if score .distance dist matches ..400 positioned ^ ^ ^0.05 rotated ~ ~ if block ~ ~ ~ #scr:raycast_pass run fill ~-1 ~-1 ~-1 ~1 ~1 ~1 air destroy

execute if score .distance dist matches ..400 positioned ^ ^ ^0.05 rotated ~ ~ if block ~ ~ ~ #scr:raycast_pass run particle minecraft:cloud ~ ~-.25 ~ .6 .6 .6 .1 1
