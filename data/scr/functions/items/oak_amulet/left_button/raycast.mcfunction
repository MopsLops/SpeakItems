...
execute if score .distance dist matches ..300 positioned ^ ^ ^0.05 rotated ~ ~ if block ~ ~ ~ #scr:raycast_pass run function scr:items/oak_amulet/left_button/raycast



#если попал в любой блок
execute if score .distance dist matches ..300 positioned ^ ^ ^0.05 rotated ~ ~ run function scr:items/oak_amulet/left_button/collide_block
